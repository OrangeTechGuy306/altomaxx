...
export default function Home() {
  return (
      <section>
          <div className="homeHeroSection min-h-[70vh] ">

          </div>
          <div className="flex justify-center items-center flex-wrap gap-7 py-2 mt-[-70px] menuIconsContainer">
              <div className="flex flex-col justify-center items-center gap-2">
                  <BsCashStack size={30} className="text-white" />
                  <small className="text-white">Make Deposit</small>
              </div>
              <div className="flex flex-col justify-center items-center gap-2">
              ...
              <div className="flex flex-col justify-center items-center gap-2">
                  <RiContactsLine size={30} className="text-white" />
          ...
          <div className=" my-10">
              ...
              <div className="my-5 flex flex-wrap justify-center items-center gap-2">
                  <Card className="homeAccountCard text-center w-[150px] h-[150px] rounded-md">
                  ...
                  <Card className="homeAccountCard1 text-center w-[150px] h-[150px] rounded-md">
                      <h1 className="text-xl font-bold text-white">&#8358;20,000</h1>
                      <small className="text-md text-white">Today&apos;s Earnings</small>
                      <div className="acOverlay"></div>
                  </Card>
                  <Card className="homeAccountCard2 text-center w-[150px] h-[150px] rounded-md">
                      <h1 className="text-xl font-bold text-white">&#8358;20,000</h1>
